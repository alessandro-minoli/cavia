...
def build_network_rp_availability_from_file(filename, I, A):
...
def build_app_rp_consumption_from_file(filename, T, D):
...
def build_b_coefficients(
    ...
    for u in range(T):
        ...
        if infeasible:
            raise InfeasibleInstance() # there is a microservice you cannot place
